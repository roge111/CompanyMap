"""
Django settings for company_map project.
...
SECRET_KEY = 'django-insecure-_jucxq!8ee8$=yt%awwl+$wajwd-jqgvh(o(dwz+tgaswq^mdr'
...
WSGI_APPLICATION = 'company_map.wsgi.application'
